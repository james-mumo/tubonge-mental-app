...
public class FinishAsProfessional extends AppCompatActivity {
    TextView mName;
    EditText mUsername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finish_as_professional);
        button = findViewById(R.id.finishprof);
        mUsername = findViewById(R.id.profname);
        mName = findViewById(R.id.hiname);
        progressBar3 = findViewById(R.id.progressBarprof);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Alerter.create(FinishAsProfessional.this)
                        .setTitle("Error")
    ...
    private void addUsername(String username) {
        ...
        Intent intent = new Intent(FinishAsProfessional.this, MainActivity.class);
