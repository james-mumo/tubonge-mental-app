    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post_vine.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(mText)) {
                Alerter.create(Post.this).setTitle("Error").setIcon(R.drawable.ic_error).setBackgroundColorRes(R.color.colorPrimary).setDuration(10000).setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf")).setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf")).enableSwipeToDismiss().setText("Enter caption").show();
            } else {
            ...
            ref.putFile(Uri.parse(uri)).addOnSuccessListener(taskSnapshot -> {
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    dRef.child(timeStamp).setValue(hashMap).addOnSuccessListener(aVoid -> {
                        ...
                        type.setText("Text");
                        Alerter.create(Post.this).setTitle("Successful").setIcon(R.drawable.ic_check_wt).setBackgroundColorRes(R.color.colorPrimaryDark).setDuration(10000).enableSwipeToDismiss().setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf")).setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf")).setText("Post Uploaded").show();
        ...
        ref.putFile(Uri.parse(uri)).addOnSuccessListener(taskSnapshot -> {
            ...
            if (uriTask.isSuccessful()) {
                ...
                dRef.child(timeStamp).setValue(hashMap).addOnSuccessListener(aVoid -> {
                    ...
                    pd.setVisibility(View.GONE);
                    remove_lt.setVisibility(View.GONE);
                }).addOnFailureListener(e -> Alerter.create(Post.this).setTitle("Error").setIcon(R.drawable.ic_check_wt).setBackgroundColorRes(R.color.colorPrimaryDark).setDuration(10000).enableSwipeToDismiss().setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf")).setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf")).setText(e.getMessage()).show());
            }
        }).addOnFailureListener(e -> {
            pd.setVisibility(View.GONE);
            Alerter.create(Post.this).setTitle("Error").setIcon(R.drawable.ic_check_wt).setBackgroundColorRes(R.color.colorPrimaryDark).setDuration(10000).enableSwipeToDismiss().setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf")).setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf")).setText(e.getMessage()).show();
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == PERMISSION_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Alerter.create(Post.this).setTitle("Error").setIcon(R.drawable.ic_error).setBackgroundColorRes(R.color.colorPrimaryDark).setDuration(10000).enableSwipeToDismiss().setTitleTypeface(Typeface.createFromAsset(getAssets(), "bold.ttf")).setTextTypeface(Typeface.createFromAsset(getAssets(), "med.ttf")).setText("Storage permission is required").show();
            }
        }
