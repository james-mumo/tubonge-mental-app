package com.jamesmumo.tubonge.menu;
...
import com.jamesmumo.tubonge.user.MyFollowing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "Tubonge - MentalHealth Social Network" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.jamesmumo.tubonge";
